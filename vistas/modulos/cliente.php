              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <button class='btn btn-warning btnCargarDatos''idClientes='".$valor["idpersona"]."' data-toggle='modal' data-target='#modificar'><i class='fas fa-edit'></i></button>
